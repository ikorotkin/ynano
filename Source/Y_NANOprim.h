...
#define NPARA  300 		/* M_PARAmeters      */

class Y_NANOprim:public Y_NANOobj
{ public:
   Y_NANOprim()
   { nipar=0;
     ndpar=0;
   ...
   INT i1par[NPARA];/* I1_PARameters_of_generalised_object			*/
   INT ieoff;
   DBL d1par[NPARA];/* D1_PARameters_of_generalised_object			*/
};
