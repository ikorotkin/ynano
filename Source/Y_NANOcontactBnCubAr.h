...
*/
#ifndef Y_NANOCONTACTBNCUBAR
#define Y_NANOCONTACTBNCUBAR
...
class Y_NANOcontactBnCubAr
{ public:
   Y_NANOcontactBnCubAr(Y_NANOobj *v0obj1,Y_NANOobj *v0obj2,Y_NANOobj *v0obj3);
};
