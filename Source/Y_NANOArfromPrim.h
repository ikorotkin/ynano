...
*/
#ifndef Y_NANOARFROMPRIM
#define Y_NANOARFROMPRIM
...
class Y_NANOArfromPrim
{ public:
   Y_NANOArfromPrim(Y_NANOobj *v0obj1,Y_NANOobj *v0obj2,Y_NANOobj *v0obj3);
};

void ArfromPrim(Y_NANOobj *v0obj1, Y_NANOobj *v0obj2);

extern Y_NANOtoolbox vtoolbox;                     /* Y_NANOtoolboxinstance           */
extern Y_NANOconvertfromPrim convertfromprim;      /* Y_NANOconvertfromPriminstance   */
