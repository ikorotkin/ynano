...
Y_NANOout::Y_NANOout(CHR *f0name)
...
void Y_NANOout::TYPEtoCHR(CHR *c1word, INT itype, INT *i0)
{ INT i;                /*                                      */
  INT idig;             /*                                      */
...
void Y_NANOout::INTtoCHR(CHR *c1word, INT inum, INT *i0)
...
void Y_NANOout::DBLtoCHR(CHR *c1word, DBL dnum, INT *i0)
{ INT i;                /*                                      */
  INT idig;             /*                                      */
  INT iexp;             /*                                      */
  INT j;                /*                                      */
...
void Y_NANOout::WriteFil(Y_NANOobj *v0obj1)
{ INT i;                /*                                      */
  INT ipar;             /*                                      */
  INT itype;            /*                                      */
  INT j;                /*                                      */
  ...
  v0obj2=(Y_NANOobj *)v0prim;
  
  vtoolbox.Y_NANOtool(&converttoprim,v0obj2,v0obj1);
  i=0;
  c1word[i]='<';
  i=i+1;
  itype=v0prim->type;
  TYPEtoCHR(c1word,itype,&i);/* Write INT type                  */
  nipar=v0prim->nipar;
