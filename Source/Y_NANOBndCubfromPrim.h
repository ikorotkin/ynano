...
*/
#ifndef Y_NANOBNDCUBFROMPRIM
#define Y_NANOBNDCUBFROMPRIM
...
class Y_NANOBndCubfromPrim
{ public:
   Y_NANOBndCubfromPrim(Y_NANOobj *v0obj1,Y_NANOobj *v0obj2,Y_NANOobj *v0obj3);
};
