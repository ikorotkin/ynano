...
{ Y_NANOatAr *v0at;        /* ATomargon                            */
  ...
  v0cvp=(Y_NANOcovepoint *)v0obj1;
  v0at=(Y_NANOatAr *)v0obj2;
  
  v0at->daccx=v0cvp->dcx;
  v0at->daccy=v0cvp->dcy;
  v0at->daccz=v0cvp->dcz;
  v0at->davcx=v0cvp->dvx;
  v0at->davcy=v0cvp->dvy;
  v0at->davcz=v0cvp->dvz;
};

Y_NANOconvertCoVePAr::Y_NANOconvertCoVePAr(Y_NANOobj *v0obj1,Y_NANOobj *v0obj2,Y_NANOobj *v0obj3)
{ vtoolbox.Y_NANOregistertool(&convert,v0obj1,v0obj2,&ConvertCoVePAr);
}
