...
*/
#ifndef Y_NANOCONVERTARCOVEP
#define Y_NANOCONVERTARCOVEP
...
class Y_NANOconvertArCoVeP
{ public:
   Y_NANOconvertArCoVeP(Y_NANOobj *v0obj1,Y_NANOobj *v0obj2,Y_NANOobj *v0obj3);
};
